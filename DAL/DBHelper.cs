...
namespace DAL
{
    public class DBHelper
    {
        ...
        /// <returns></returns>
        public static DataSet ExecuteProcOutValue(string proname, Dictionary<string, object> pairs,
            string outname, out object outvalue)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(strConn))
                {
                    ...
                    outvalue = comm.Parameters[outname].Value;
